 ...
 *         &lt;element name="hostDnGroup" type="{http://www.cisco.com/AXL/API/11.0}XFkType" minOccurs="0"/>
 *         &lt;element name="safSipTrunk" type="{http://www.cisco.com/AXL/API/11.0}XFkType" minOccurs="0"/>
 *         &lt;element name="safH323Trunk" type="{http://www.cisco.com/AXL/API/11.0}XFkType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends NameAndGUIDRequest
{
    ...
    @XmlElementRef(name = "safSipTrunk", type = JAXBElement.class, required = false)
    protected JAXBElement<XFkType> safSipTrunk;
    @XmlElementRef(name = "safH323Trunk", type = JAXBElement.class, required = false)
