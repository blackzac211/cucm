 ...
 *         &lt;element name="geoLocationPolicyAName" type="{http://www.cisco.com/AXL/API/11.0}XFkType"/>
 *         &lt;element name="geoLocationDeviceA" type="{http://www.cisco.com/AXL/API/11.0}XGeoLocationDevice"/>
 *         &lt;element name="geoLocationPolicyBName" type="{http://www.cisco.com/AXL/API/11.0}XFkType"/>
 *         &lt;element name="geoLocationDeviceB" type="{http://www.cisco.com/AXL/API/11.0}XGeoLocationDevice"/>
 *         &lt;element name="logicalPartitionPolicy" type="{http://www.cisco.com/AXL/API/11.0}XLogicalPartitionPolicy"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class XPolicyRelationship {
    ...
    @XmlElementRef(name = "geoLocationPolicyAName", type = JAXBElement.class, required = false)
    protected JAXBElement<XFkType> geoLocationPolicyAName;
    protected String geoLocationDeviceA;
    @XmlElementRef(name = "geoLocationPolicyBName", type = JAXBElement.class, required = false)
