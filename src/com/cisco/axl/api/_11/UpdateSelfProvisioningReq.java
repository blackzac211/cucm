 ...
 *                     &lt;sequence minOccurs="0">
 *                       &lt;element name="language" type="{http://www.cisco.com/AXL/API/11.0}XSelfProvisionRemove" maxOccurs="9" minOccurs="0"/>
 *                     &lt;/sequence>
 *                   &lt;/extension>
 *                 &lt;/complexContent>
 *               &lt;/complexType>
 ...
 *                   &lt;extension base="{http://www.cisco.com/AXL/API/11.0}XCommonMembersExtension">
 *                     &lt;sequence minOccurs="0">
 *                       &lt;element name="language" type="{http://www.cisco.com/AXL/API/11.0}XSelfProvision" maxOccurs="9" minOccurs="0"/>
 *                     &lt;/sequence>
 *                   &lt;/extension>
 *                 &lt;/complexContent>
 *               &lt;/complexType>
    ...
    extends APIRequest
{
    ...
    @XmlElementRef(name = "requireAuthentication", type = JAXBElement.class, required = false)
    protected JAXBElement<String> requireAuthentication;
    @XmlElementRef(name = "allowAuthentication", type = JAXBElement.class, required = false)
    protected JAXBElement<String> allowAuthentication;
    @XmlElementRef(name = "authenticationCode", type = JAXBElement.class, required = false)
    protected JAXBElement<String> authenticationCode;
    @XmlElementRef(name = "ctiRoutePoint", type = JAXBElement.class, required = false)
    protected JAXBElement<String> ctiRoutePoint;
    @XmlElementRef(name = "applicationUser", type = JAXBElement.class, required = false)
