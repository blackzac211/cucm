    ...
    extends APIRequest
{
    ...
    @XmlElementRef(name = "secondarySoftSwitchId", type = JAXBElement.class, required = false)
    protected JAXBElement<String> secondarySoftSwitchId;
    protected String objectClass;
    @XmlElementRef(name = "subscriberType", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "sipUserNameSuffix", type = JAXBElement.class, required = false)
