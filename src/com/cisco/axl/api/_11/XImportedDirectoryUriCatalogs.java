 ...
 *         &lt;element name="fileLoadDateTime" type="{http://www.cisco.com/AXL/API/11.0}XInteger" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class XImportedDirectoryUriCatalogs {
    ...
    @XmlElementRef(name = "lastLoadedFileName", type = JAXBElement.class, required = false)
    protected JAXBElement<String> lastLoadedFileName;
    @XmlElementRef(name = "fileLoadDateTime", type = JAXBElement.class, required = false)
