 ...
 *         &lt;element name="dnCallingSearchSpace" type="{http://www.cisco.com/AXL/API/11.0}XFkType" minOccurs="0"/>
 *         &lt;element name="aarNeighborhoodName" type="{http://www.cisco.com/AXL/API/11.0}XFkType" minOccurs="0"/>
 *         &lt;element name="callerIdDisplay" type="{http://www.cisco.com/AXL/API/11.0}String128" minOccurs="0"/>
 *         &lt;element name="callerIdDisplayAscii" type="{http://www.cisco.com/AXL/API/11.0}String50" minOccurs="0"/>
...
public class XVoiceMailPort {
    ...
    @XmlElementRef(name = "dnCallingSearchSpace", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "externalMask", type = JAXBElement.class, required = false)
