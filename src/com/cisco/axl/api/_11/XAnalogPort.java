 ...
 *         &lt;element name="portNumber" type="{http://www.cisco.com/AXL/API/11.0}XInteger"/>
 *         &lt;element name="attendantDn" type="{http://www.cisco.com/AXL/API/11.0}String255" minOccurs="0"/>
 ...
 *         &lt;element name="callerIdEnable" type="{http://www.cisco.com/AXL/API/11.0}boolean"/>
 ...
 *         &lt;element name="expectedDigits" type="{http://www.cisco.com/AXL/API/11.0}XInteger"/>
 ...
 *           &lt;/complexType>
 *         &lt;/element>
 *         &lt;element name="prefixDn" type="{http://www.cisco.com/AXL/API/11.0}String255" minOccurs="0"/>
 *         &lt;element name="presentationBit" type="{http://www.cisco.com/AXL/API/11.0}XPresentationBit" minOccurs="0"/>
 *         &lt;element name="silenceSuppressionThreshold" type="{http://www.cisco.com/AXL/API/11.0}XSilenceSuppressionThreshold" minOccurs="0"/>
 *         &lt;element name="smdiPortNumber" type="{http://www.cisco.com/AXL/API/11.0}XInteger"/>
 *         &lt;element name="startDialProtocol" type="{http://www.cisco.com/AXL/API/11.0}XStartDialProtocol" minOccurs="0"/>
 *         &lt;element name="trunk" type="{http://www.cisco.com/AXL/API/11.0}XTrunk" minOccurs="0"/>
 *         &lt;element name="trunkDirection" type="{http://www.cisco.com/AXL/API/11.0}XTrunkDirection"/>
 *         &lt;element name="trunkLevel" type="{http://www.cisco.com/AXL/API/11.0}XTrunkLevel" minOccurs="0"/>
 *         &lt;element name="trunkPadRx" type="{http://www.cisco.com/AXL/API/11.0}XTrunkPad" minOccurs="0"/>
 *         &lt;element name="trunkPadTx" type="{http://www.cisco.com/AXL/API/11.0}XTrunkPad" minOccurs="0"/>
 *         &lt;element name="vendorConfig" type="{http://www.cisco.com/AXL/API/11.0}XVendorConfig" minOccurs="0"/>
 *         &lt;element name="timer1" type="{http://www.cisco.com/AXL/API/11.0}XInteger"/>
 *         &lt;element name="timer2" type="{http://www.cisco.com/AXL/API/11.0}XInteger"/>
 *         &lt;element name="timer3" type="{http://www.cisco.com/AXL/API/11.0}XInteger"/>
 *         &lt;element name="timer4" type="{http://www.cisco.com/AXL/API/11.0}XInteger"/>
 *         &lt;element name="timer5" type="{http://www.cisco.com/AXL/API/11.0}XInteger"/>
 *         &lt;element name="timer6" type="{http://www.cisco.com/AXL/API/11.0}XInteger"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class XAnalogPort {
    ...
    @XmlElementRef(name = "vendorConfig", type = JAXBElement.class, required = false)
