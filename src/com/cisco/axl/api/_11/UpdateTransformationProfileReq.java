 ...
 *         &lt;element name="nationalCssName" type="{http://www.cisco.com/AXL/API/11.0}XFkType" minOccurs="0"/>
 *         &lt;element name="internationalCssName" type="{http://www.cisco.com/AXL/API/11.0}XFkType" minOccurs="0"/>
 *         &lt;element name="unknownCssName" type="{http://www.cisco.com/AXL/API/11.0}XFkType" minOccurs="0"/>
 *         &lt;element name="subscriberCssName" type="{http://www.cisco.com/AXL/API/11.0}XFkType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends NameAndGUIDRequest
{
    ...
    @XmlElementRef(name = "nationalCssName", type = JAXBElement.class, required = false)
    protected JAXBElement<XFkType> nationalCssName;
    @XmlElementRef(name = "internationalCssName", type = JAXBElement.class, required = false)
    protected JAXBElement<XFkType> internationalCssName;
    @XmlElementRef(name = "unknownCssName", type = JAXBElement.class, required = false)
    protected JAXBElement<XFkType> unknownCssName;
    @XmlElementRef(name = "subscriberCssName", type = JAXBElement.class, required = false)
