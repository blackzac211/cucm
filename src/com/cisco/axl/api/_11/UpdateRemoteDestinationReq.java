 ...
 *         &lt;element name="answerTooSoonTimer" type="{http://www.cisco.com/AXL/API/11.0}XInteger" minOccurs="0"/>
 *         &lt;element name="answerTooLateTimer" type="{http://www.cisco.com/AXL/API/11.0}XInteger" minOccurs="0"/>
 *         &lt;element name="delayBeforeRingingCell" type="{http://www.cisco.com/AXL/API/11.0}XInteger" minOccurs="0"/>
 *         &lt;element name="ownerUserId" type="{http://www.cisco.com/AXL/API/11.0}XFkType" minOccurs="0"/>
 *         &lt;element name="enableUnifiedMobility" type="{http://www.cisco.com/AXL/API/11.0}boolean" minOccurs="0"/>
 *         &lt;element name="remoteDestinationProfileName" type="{http://www.cisco.com/AXL/API/11.0}XFkType" minOccurs="0"/>
 *         &lt;element name="enableExtendAndConnect" type="{http://www.cisco.com/AXL/API/11.0}boolean" minOccurs="0"/>
 *         &lt;element name="ctiRemoteDeviceName" type="{http://www.cisco.com/AXL/API/11.0}XFkType" minOccurs="0"/>
 *         &lt;element name="dualModeDeviceName" type="{http://www.cisco.com/AXL/API/11.0}XFkType" minOccurs="0"/>
 *         &lt;element name="isMobilePhone" type="{http://www.cisco.com/AXL/API/11.0}boolean" minOccurs="0"/>
 *         &lt;element name="enableMobileConnect" type="{http://www.cisco.com/AXL/API/11.0}boolean" minOccurs="0"/>
 *         &lt;element name="lineAssociations" minOccurs="0">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence minOccurs="0">
 *                   &lt;element name="lineAssociation" type="{http://www.cisco.com/AXL/API/11.0}XLineAssociation" maxOccurs="unbounded"/>
 *                 &lt;/sequence>
 *               &lt;/restriction>
 *             &lt;/complexContent>
 *           &lt;/complexType>
 *         &lt;/element>
 *         &lt;element name="timeZone" type="{http://www.cisco.com/AXL/API/11.0}XTimeZone" minOccurs="0"/>
 *         &lt;element name="todAccessName" type="{http://www.cisco.com/AXL/API/11.0}XFkType" minOccurs="0"/>
 *         &lt;element name="mobileSmartClientName" type="{http://www.cisco.com/AXL/API/11.0}XFkType" minOccurs="0"/>
 *         &lt;element name="mobilityProfileName" type="{http://www.cisco.com/AXL/API/11.0}XFkType" minOccurs="0"/>
 *         &lt;element name="singleNumberReachVoicemail" type="{http://www.cisco.com/AXL/API/11.0}XVMAvoidancePolicy" minOccurs="0"/>
 *         &lt;element name="dialViaOfficeReverseVoicemail" type="{http://www.cisco.com/AXL/API/11.0}XVMAvoidancePolicy" minOccurs="0"/>
 *         &lt;choice minOccurs="0">
 *           &lt;sequence minOccurs="0">
 *             &lt;element name="removeRingSchedule" minOccurs="0">
 *               &lt;complexType>
 *                 &lt;complexContent>
 *                   &lt;extension base="{http://www.cisco.com/AXL/API/11.0}XCommonMembersExtension">
 *                     &lt;sequence minOccurs="0">
 *                       &lt;element name="member" type="{http://www.cisco.com/AXL/API/11.0}XRingingSchedule" maxOccurs="7"/>
 *                     &lt;/sequence>
 *                   &lt;/extension>
 *                 &lt;/complexContent>
 *               &lt;/complexType>
 *             &lt;/element>
 *             &lt;element name="addRingSchedule" minOccurs="0">
 *               &lt;complexType>
 *                 &lt;complexContent>
 *                   &lt;extension base="{http://www.cisco.com/AXL/API/11.0}XCommonMembersExtension">
 *                     &lt;sequence minOccurs="0">
 ...
 *           &lt;/element>
 *         &lt;/choice>
 *         &lt;element name="accessListName" type="{http://www.cisco.com/AXL/API/11.0}XFkType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends APIRequest
{
    ...
    @XmlElementRef(name = "remoteDestinationProfileName", type = JAXBElement.class, required = false)
    protected JAXBElement<XFkType> remoteDestinationProfileName;
    protected String enableExtendAndConnect;
    @XmlElementRef(name = "ctiRemoteDeviceName", type = JAXBElement.class, required = false)
    protected JAXBElement<XFkType> ctiRemoteDeviceName;
    @XmlElementRef(name = "dualModeDeviceName", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "todAccessName", type = JAXBElement.class, required = false)
    protected JAXBElement<XFkType> todAccessName;
    @XmlElementRef(name = "mobileSmartClientName", type = JAXBElement.class, required = false)
    protected JAXBElement<XFkType> mobileSmartClientName;
    @XmlElementRef(name = "mobilityProfileName", type = JAXBElement.class, required = false)
    ...
    protected UpdateRemoteDestinationReq.RemoveRingSchedule removeRingSchedule;
    protected UpdateRemoteDestinationReq.AddRingSchedule addRingSchedule;
    protected UpdateRemoteDestinationReq.RingSchedule ringSchedule;
    @XmlElementRef(name = "accessListName", type = JAXBElement.class, required = false)
    ...
    /**
     * Gets the value of the removeRingSchedule property.
     * 
     * @return
     *     possible object is
     *     {@link UpdateRemoteDestinationReq.RemoveRingSchedule }
     *     
     */
    public UpdateRemoteDestinationReq.RemoveRingSchedule getRemoveRingSchedule() {
        return removeRingSchedule;
    }

    /**
     * Sets the value of the removeRingSchedule property.
     * 
     * @param value
     *     allowed object is
     *     {@link UpdateRemoteDestinationReq.RemoveRingSchedule }
     *     
     */
    public void setRemoveRingSchedule(UpdateRemoteDestinationReq.RemoveRingSchedule value) {
        this.removeRingSchedule = value;
    }

    /**
     * Gets the value of the addRingSchedule property.
     * 
     * @return
     *     possible object is
     *     {@link UpdateRemoteDestinationReq.AddRingSchedule }
     *     
     */
    public UpdateRemoteDestinationReq.AddRingSchedule getAddRingSchedule() {
        return addRingSchedule;
    }

    /**
     * Sets the value of the addRingSchedule property.
     * 
     * @param value
     *     allowed object is
     *     {@link UpdateRemoteDestinationReq.AddRingSchedule }
     *     
     */
    public void setAddRingSchedule(UpdateRemoteDestinationReq.AddRingSchedule value) {
        this.addRingSchedule = value;
    }
     ...
     * @return
     *     possible object is
     *     {@link UpdateRemoteDestinationReq.RingSchedule }
     *     
     */
    public UpdateRemoteDestinationReq.RingSchedule getRingSchedule() {
        return ringSchedule;
    }
     ...
     *     
     */
    public void setRingSchedule(UpdateRemoteDestinationReq.RingSchedule value) {
    ...
    public static class AddRingSchedule
    ...
    public static class RemoveRingSchedule
        extends XCommonMembersExtension
    {
