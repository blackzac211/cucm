 ...
 *       &lt;sequence>
 *         &lt;element name="syncEnabled" type="{http://www.cisco.com/AXL/API/11.0}boolean" minOccurs="0"/>
 *         &lt;element name="ldapServer" type="{http://www.cisco.com/AXL/API/11.0}XLdapServer" minOccurs="0"/>
 *         &lt;element name="userIdAttribute" type="{http://www.cisco.com/AXL/API/11.0}String64" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class UpdateLdapSystemReq {
    ...
    @XmlElementRef(name = "ldapServer", type = JAXBElement.class, required = false)
