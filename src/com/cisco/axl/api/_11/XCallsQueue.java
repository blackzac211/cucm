 ...
 *         &lt;element name="maxCallersInQueue" type="{http://www.cisco.com/AXL/API/11.0}XInteger"/>
 *         &lt;element name="queueFullDestination" type="{http://www.cisco.com/AXL/API/11.0}String50" minOccurs="0"/>
 *         &lt;element name="callingSearchSpacePilotQueueFull" type="{http://www.cisco.com/AXL/API/11.0}XFkType" minOccurs="0"/>
 *         &lt;element name="maxWaitTimeInQueue" type="{http://www.cisco.com/AXL/API/11.0}XInteger"/>
 *         &lt;element name="maxWaitTimeDestination" type="{http://www.cisco.com/AXL/API/11.0}String50" minOccurs="0"/>
 *         &lt;element name="callingSearchSpaceMaxWaitTime" type="{http://www.cisco.com/AXL/API/11.0}XFkType" minOccurs="0"/>
 *         &lt;element name="noAgentDestination" type="{http://www.cisco.com/AXL/API/11.0}String50" minOccurs="0"/>
 *         &lt;element name="callingSearchSpaceNoAgent" type="{http://www.cisco.com/AXL/API/11.0}XFkType" minOccurs="0"/>
 *         &lt;element name="networkHoldMohAudioSourceID" type="{http://www.cisco.com/AXL/API/11.0}XInteger" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class XCallsQueue {
    ...
    @XmlElementRef(name = "queueFullDestination", type = JAXBElement.class, required = false)
    protected JAXBElement<String> queueFullDestination;
    @XmlElementRef(name = "callingSearchSpacePilotQueueFull", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "maxWaitTimeDestination", type = JAXBElement.class, required = false)
    protected JAXBElement<String> maxWaitTimeDestination;
    @XmlElementRef(name = "callingSearchSpaceMaxWaitTime", type = JAXBElement.class, required = false)
    protected JAXBElement<XFkType> callingSearchSpaceMaxWaitTime;
    @XmlElementRef(name = "noAgentDestination", type = JAXBElement.class, required = false)
    protected JAXBElement<String> noAgentDestination;
    @XmlElementRef(name = "callingSearchSpaceNoAgent", type = JAXBElement.class, required = false)
