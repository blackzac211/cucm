 ...
 *         &lt;element name="forwardToVoiceMail" type="{http://www.cisco.com/AXL/API/11.0}boolean" minOccurs="0"/>
 *         &lt;element name="callingSearchSpaceName" type="{http://www.cisco.com/AXL/API/11.0}XFkType"/>
 *         &lt;element name="secondaryCallingSearchSpaceName" type="{http://www.cisco.com/AXL/API/11.0}XFkType"/>
...
public class XCallForwardAll {
    ...
    @XmlElementRef(name = "secondaryCallingSearchSpaceName", type = JAXBElement.class, required = false)
