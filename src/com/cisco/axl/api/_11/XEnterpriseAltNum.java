 ...
 *         &lt;element name="addToLocalRoutePartition" type="{http://www.cisco.com/AXL/API/11.0}boolean" minOccurs="0"/>
...
public class XEnterpriseAltNum {
    ...
    @XmlElementRef(name = "numberMask", type = JAXBElement.class, required = false)
