...
public class XLicensedUser {
    ...
    @XmlElementRef(name = "snrEnabled", type = JAXBElement.class, required = false)
    protected JAXBElement<String> snrEnabled;
    @XmlElementRef(name = "emEnabled", type = JAXBElement.class, required = false)
    protected JAXBElement<String> emEnabled;
    @XmlElementRef(name = "deviceCount", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "licenseUsed", type = JAXBElement.class, required = false)
