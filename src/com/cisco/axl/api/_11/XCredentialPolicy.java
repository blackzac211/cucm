 ...
 *         &lt;element name="name" type="{http://www.cisco.com/AXL/API/11.0}String255"/>
 *         &lt;element name="failedLogon" type="{http://www.cisco.com/AXL/API/11.0}XInteger"/>
 *         &lt;element name="resetFailedLogonAttempts" type="{http://www.cisco.com/AXL/API/11.0}XInteger"/>
 *         &lt;element name="lockoutDuration" type="{http://www.cisco.com/AXL/API/11.0}XInteger"/>
 *         &lt;element name="credChangeDuration" type="{http://www.cisco.com/AXL/API/11.0}XInteger"/>
 *         &lt;element name="credExpiresAfter" type="{http://www.cisco.com/AXL/API/11.0}XInteger"/>
 *         &lt;element name="minCredLength" type="{http://www.cisco.com/AXL/API/11.0}XInteger"/>
 *         &lt;element name="prevCredStoredNum" type="{http://www.cisco.com/AXL/API/11.0}XInteger"/>
 *         &lt;element name="inactiveDaysAllowed" type="{http://www.cisco.com/AXL/API/11.0}XInteger"/>
 *         &lt;element name="expiryWarningDays" type="{http://www.cisco.com/AXL/API/11.0}XInteger"/>
 *         &lt;element name="trivialCredCheck" type="{http://www.cisco.com/AXL/API/11.0}boolean"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
