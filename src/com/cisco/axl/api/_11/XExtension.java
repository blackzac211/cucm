 ...
 *         &lt;element name="sortOrder" type="{http://www.cisco.com/AXL/API/11.0}XInteger" minOccurs="0"/>
 *         &lt;element name="pattern" type="{http://www.cisco.com/AXL/API/11.0}XFkType"/>
 ...
 *         &lt;element name="partition" type="{http://www.cisco.com/AXL/API/11.0}XFkType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class XExtension {
    ...
    @XmlElementRef(name = "sortOrder", type = JAXBElement.class, required = false)
    protected JAXBElement<String> sortOrder;
    protected XFkType pattern;
    protected String routePartition;
    @XmlElementRef(name = "linePrimaryUri", type = JAXBElement.class, required = false)
