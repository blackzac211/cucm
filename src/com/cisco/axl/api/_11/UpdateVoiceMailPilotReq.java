 ...
 *           &lt;/sequence>
 *         &lt;/choice>
 *         &lt;element name="newDirn" type="{http://www.cisco.com/AXL/API/11.0}String255" minOccurs="0"/>
 *         &lt;element name="description" type="{http://www.cisco.com/AXL/API/11.0}String50" minOccurs="0"/>
 *         &lt;element name="newCssName" type="{http://www.cisco.com/AXL/API/11.0}XFkType" minOccurs="0"/>
    ...
    extends APIRequest
{
    ...
    @XmlElementRef(name = "newDirn", type = JAXBElement.class, required = false)
    protected JAXBElement<String> newDirn;
    protected String description;
    @XmlElementRef(name = "newCssName", type = JAXBElement.class, required = false)
