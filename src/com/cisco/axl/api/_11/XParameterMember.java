 ...
 *         &lt;element name="parameter" type="{http://www.cisco.com/AXL/API/11.0}XDialParameter" minOccurs="0"/>
...
public class XParameterMember {
    ...
    @XmlElementRef(name = "selectionOrder", type = JAXBElement.class, required = false)
