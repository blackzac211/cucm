 ...
 *         &lt;element name="routeGroupName" type="{http://www.cisco.com/AXL/API/11.0}XFkType"/>
 *         &lt;element name="selectionOrder" type="{http://www.cisco.com/AXL/API/11.0}XInteger"/>
 *         &lt;element name="calledPartyTransformationMask" type="{http://www.cisco.com/AXL/API/11.0}String50" minOccurs="0"/>
 *         &lt;element name="callingPartyTransformationMask" type="{http://www.cisco.com/AXL/API/11.0}String50" minOccurs="0"/>
 ...
 *         &lt;element name="prefixDigitsOut" type="{http://www.cisco.com/AXL/API/11.0}String50" minOccurs="0"/>
 *         &lt;element name="useFullyQualifiedCallingPartyNumber" type="{http://www.cisco.com/AXL/API/11.0}XStatus"/>
...
public class XRouteListMember {
    ...
    @XmlElementRef(name = "routeGroupName", type = JAXBElement.class, required = false)
