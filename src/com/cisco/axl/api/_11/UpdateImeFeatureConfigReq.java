 ...
 *       &lt;sequence>
 *         &lt;element name="preventImeCallsFromAnalogGateways" type="{http://www.cisco.com/AXL/API/11.0}boolean" minOccurs="0"/>
 *         &lt;element name="enableIntraDomain" type="{http://www.cisco.com/AXL/API/11.0}boolean" minOccurs="0"/>
 *         &lt;element name="allowMwiNotification" type="{http://www.cisco.com/AXL/API/11.0}boolean" minOccurs="0"/>
 *         &lt;element name="trunkConnectionTimer" type="{http://www.cisco.com/AXL/API/11.0}XInteger" minOccurs="0"/>
 *         &lt;element name="firewallConnectionTimer" type="{http://www.cisco.com/AXL/API/11.0}XInteger" minOccurs="0"/>
 *         &lt;element name="firewallTranscationTimer" type="{http://www.cisco.com/AXL/API/11.0}XInteger" minOccurs="0"/>
 *         &lt;element name="firewallIdleTimer" type="{http://www.cisco.com/AXL/API/11.0}XInteger" minOccurs="0"/>
 *         &lt;element name="failedCallAttemptThreshold" type="{http://www.cisco.com/AXL/API/11.0}XInteger" minOccurs="0"/>
 *         &lt;element name="callFallbackAttemptThreshold" type="{http://www.cisco.com/AXL/API/11.0}XInteger" minOccurs="0"/>
 *         &lt;element name="qualityTimer" type="{http://www.cisco.com/AXL/API/11.0}XInteger" minOccurs="0"/>
 *         &lt;element name="useImeForOutboundCalls" type="{http://www.cisco.com/AXL/API/11.0}boolean" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class UpdateImeFeatureConfigReq {
    ...
    @XmlElementRef(name = "preventImeCallsFromAnalogGateways", type = JAXBElement.class, required = false)
    protected JAXBElement<String> preventImeCallsFromAnalogGateways;
    @XmlElementRef(name = "enableIntraDomain", type = JAXBElement.class, required = false)
    protected JAXBElement<String> enableIntraDomain;
    @XmlElementRef(name = "allowMwiNotification", type = JAXBElement.class, required = false)
    protected JAXBElement<String> allowMwiNotification;
    @XmlElementRef(name = "trunkConnectionTimer", type = JAXBElement.class, required = false)
    protected JAXBElement<String> trunkConnectionTimer;
    @XmlElementRef(name = "firewallConnectionTimer", type = JAXBElement.class, required = false)
    protected JAXBElement<String> firewallConnectionTimer;
    @XmlElementRef(name = "firewallTranscationTimer", type = JAXBElement.class, required = false)
    protected JAXBElement<String> firewallTranscationTimer;
    protected String firewallIdleTimer;
    @XmlElementRef(name = "failedCallAttemptThreshold", type = JAXBElement.class, required = false)
    protected JAXBElement<String> failedCallAttemptThreshold;
    @XmlElementRef(name = "callFallbackAttemptThreshold", type = JAXBElement.class, required = false)
    protected JAXBElement<String> callFallbackAttemptThreshold;
    @XmlElementRef(name = "qualityTimer", type = JAXBElement.class, required = false)
    protected JAXBElement<String> qualityTimer;
    @XmlElementRef(name = "useImeForOutboundCalls", type = JAXBElement.class, required = false)
