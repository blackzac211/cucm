 ...
 *         &lt;element name="processNodeRole" type="{http://www.cisco.com/AXL/API/11.0}XProcessNodeRole"/>
...
public class XProcessNode {
    ...
    @XmlElementRef(name = "lbmHubGroup", type = JAXBElement.class, required = false)
