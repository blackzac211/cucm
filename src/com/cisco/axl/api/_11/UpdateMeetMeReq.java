 ...
 *         &lt;element name="minimumSecurityLevel" type="{http://www.cisco.com/AXL/API/11.0}XDeviceSecurityMode" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends APIRequest
{
    ...
    @XmlElementRef(name = "minimumSecurityLevel", type = JAXBElement.class, required = false)
