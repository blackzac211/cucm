 ...
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence minOccurs="0">
 *                   &lt;element name="addOnModule" type="{http://www.cisco.com/AXL/API/11.0}XAddOnModule" maxOccurs="2" minOccurs="0"/>
 *                 &lt;/sequence>
 *               &lt;/restriction>
 *             &lt;/complexContent>
 *           &lt;/complexType>
...
public class XDeviceProfile {
    ...
    @XmlElementRef(name = "loginUserId", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "emccCallingSearchSpace", type = JAXBElement.class, required = false)
