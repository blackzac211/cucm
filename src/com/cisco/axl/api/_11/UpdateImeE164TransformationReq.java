 ...
 *         &lt;element name="isCgpnPreTransformation" type="{http://www.cisco.com/AXL/API/11.0}boolean" minOccurs="0"/>
 *         &lt;element name="cdpnTransformationCssName" type="{http://www.cisco.com/AXL/API/11.0}XFkType" minOccurs="0"/>
 *         &lt;element name="isCdpnPreTransformation" type="{http://www.cisco.com/AXL/API/11.0}boolean" minOccurs="0"/>
 *         &lt;element name="incomingCgpnTransformationProfileName" type="{http://www.cisco.com/AXL/API/11.0}XFkType" minOccurs="0"/>
 *         &lt;element name="incomingCdpnTransformationProfileName" type="{http://www.cisco.com/AXL/API/11.0}XFkType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends NameAndGUIDRequest
{
    ...
    @XmlElementRef(name = "incomingCgpnTransformationProfileName", type = JAXBElement.class, required = false)
    protected JAXBElement<XFkType> incomingCgpnTransformationProfileName;
    @XmlElementRef(name = "incomingCdpnTransformationProfileName", type = JAXBElement.class, required = false)
