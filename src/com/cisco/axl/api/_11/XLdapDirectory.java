 ...
 *         &lt;element name="ldapDn" type="{http://www.cisco.com/AXL/API/11.0}String128"/>
 *         &lt;element name="ldapPassword" type="{http://www.cisco.com/AXL/API/11.0}String128"/>
 *         &lt;element name="userSearchBase" type="{http://www.cisco.com/AXL/API/11.0}String255"/>
 *         &lt;element name="repeatable" type="{http://www.cisco.com/AXL/API/11.0}boolean" minOccurs="0"/>
 *         &lt;element name="intervalValue" type="{http://www.cisco.com/AXL/API/11.0}XInteger"/>
 *         &lt;element name="scheduleUnit" type="{http://www.cisco.com/AXL/API/11.0}XScheduleUnit" minOccurs="0"/>
 *         &lt;element name="nextExecTime" type="{http://www.cisco.com/AXL/API/11.0}String32"/>
 ...
 *                         &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                           &lt;sequence minOccurs="0">
 *                             &lt;element name="hostName" type="{http://www.cisco.com/AXL/API/11.0}String128"/>
 *                             &lt;element name="ldapPortNumber" type="{http://www.cisco.com/AXL/API/11.0}XInteger"/>
...
public class XLdapDirectory {
    ...
    @XmlElementRef(name = "intervalValue", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "ldapFilter", type = JAXBElement.class, required = false)
    protected JAXBElement<XFkType> ldapFilter;
    @XmlElement(defaultValue = "false")
    protected String synchronize;
    @XmlElementRef(name = "ldapFilterForGroups", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "featureGroupTemplate", type = JAXBElement.class, required = false)
