 ...
 *         &lt;element name="label" type="{http://www.cisco.com/AXL/API/11.0}String50" minOccurs="0"/>
 *         &lt;element name="display" type="{http://www.cisco.com/AXL/API/11.0}String50" minOccurs="0"/>
 *         &lt;element name="dirn" type="{http://www.cisco.com/AXL/API/11.0}XDirn"/>
 *         &lt;element name="ringSetting" type="{http://www.cisco.com/AXL/API/11.0}XRingSetting" minOccurs="0"/>
 *         &lt;element name="consecutiveRingSetting" type="{http://www.cisco.com/AXL/API/11.0}XRingSetting" minOccurs="0"/>
 *         &lt;element name="ringSettingIdlePickupAlert" type="{http://www.cisco.com/AXL/API/11.0}XRingSetting" minOccurs="0"/>
 *         &lt;element name="ringSettingActivePickupAlert" type="{http://www.cisco.com/AXL/API/11.0}XRingSetting" minOccurs="0"/>
 *         &lt;element name="displayAscii" type="{http://www.cisco.com/AXL/API/11.0}String50" minOccurs="0"/>
 *         &lt;element name="e164Mask" type="{http://www.cisco.com/AXL/API/11.0}String255" minOccurs="0"/>
 *         &lt;element name="mwlPolicy" type="{http://www.cisco.com/AXL/API/11.0}XMWLPolicy" minOccurs="0"/>
 *         &lt;element name="maxNumCalls" type="{http://www.cisco.com/AXL/API/11.0}XInteger" minOccurs="0"/>
 ...
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence minOccurs="0">
 *                   &lt;element name="callerName" type="{http://www.cisco.com/AXL/API/11.0}boolean" minOccurs="0"/>
 *                   &lt;element name="callerNumber" type="{http://www.cisco.com/AXL/API/11.0}boolean" minOccurs="0"/>
 *                   &lt;element name="redirectedNumber" type="{http://www.cisco.com/AXL/API/11.0}boolean" minOccurs="0"/>
 *                   &lt;element name="dialedNumber" type="{http://www.cisco.com/AXL/API/11.0}boolean" minOccurs="0"/>
 *                 &lt;/sequence>
 *               &lt;/restriction>
 *             &lt;/complexContent>
 *           &lt;/complexType>
 *         &lt;/element>
 *         &lt;element name="recordingProfileName" type="{http://www.cisco.com/AXL/API/11.0}XFkType" minOccurs="0"/>
 *         &lt;element name="monitoringCssName" type="{http://www.cisco.com/AXL/API/11.0}XFkType" minOccurs="0"/>
 *         &lt;element name="recordingFlag" type="{http://www.cisco.com/AXL/API/11.0}XRecordingFlag" minOccurs="0"/>
 *         &lt;element name="audibleMwi" type="{http://www.cisco.com/AXL/API/11.0}XStatus" minOccurs="0"/>
 *         &lt;element name="speedDial" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *         &lt;element name="partitionUsage" type="{http://www.cisco.com/AXL/API/11.0}XPartitionUsage" minOccurs="0"/>
 *         &lt;element name="associatedEndusers" minOccurs="0">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence minOccurs="0">
 *                   &lt;element name="enduser" type="{http://www.cisco.com/AXL/API/11.0}XEnduserMember" maxOccurs="unbounded" minOccurs="0"/>
 *                 &lt;/sequence>
 *               &lt;/restriction>
 *             &lt;/complexContent>
 *           &lt;/complexType>
 *         &lt;/element>
 *         &lt;element name="missedCallLogging" type="{http://www.cisco.com/AXL/API/11.0}boolean" minOccurs="0"/>
 *         &lt;element name="recordingMediaSource" type="{http://www.cisco.com/AXL/API/11.0}XPreferredMediaSource"/>
 *       &lt;/sequence>
...
public class XPhoneLine {
    ...
    @XmlElementRef(name = "consecutiveRingSetting", type = JAXBElement.class, required = false)
    protected JAXBElement<String> consecutiveRingSetting;
    @XmlElementRef(name = "ringSettingIdlePickupAlert", type = JAXBElement.class, required = false)
    protected JAXBElement<String> ringSettingIdlePickupAlert;
    @XmlElementRef(name = "ringSettingActivePickupAlert", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "recordingProfileName", type = JAXBElement.class, required = false)
    protected JAXBElement<XFkType> recordingProfileName;
    @XmlElementRef(name = "monitoringCssName", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "speedDial", type = JAXBElement.class, required = false)
