 ...
 *         &lt;element name="primaryUri" type="{http://www.cisco.com/AXL/API/11.0}String255" minOccurs="0"/>
 *         &lt;element name="secondaryUri" type="{http://www.cisco.com/AXL/API/11.0}String255" minOccurs="0"/>
 *         &lt;element name="enableLoadBalancing" type="{http://www.cisco.com/AXL/API/11.0}boolean" minOccurs="0"/>
 *         &lt;element name="routingRequestTimer" type="{http://www.cisco.com/AXL/API/11.0}XInteger" minOccurs="0"/>
 *         &lt;element name="diversionReroutingCssName" type="{http://www.cisco.com/AXL/API/11.0}XFkType" minOccurs="0"/>
 *         &lt;element name="callTreatmentOnFailure" type="{http://www.cisco.com/AXL/API/11.0}XCallTreatmentOnFailure" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends NameAndGUIDRequest
{
    ...
    @XmlElementRef(name = "routingRequestTimer", type = JAXBElement.class, required = false)
    protected JAXBElement<String> routingRequestTimer;
    @XmlElementRef(name = "diversionReroutingCssName", type = JAXBElement.class, required = false)
