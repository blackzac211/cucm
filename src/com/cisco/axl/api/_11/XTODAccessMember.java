 ...
 *         &lt;element name="timeScheduleName" type="{http://www.cisco.com/AXL/API/11.0}XFkType" minOccurs="0"/>
...
public class XTODAccessMember {
    ...
    @XmlElementRef(name = "timeScheduleName", type = JAXBElement.class, required = false)
