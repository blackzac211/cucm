 ...
 *         &lt;element name="dirn" type="{http://www.cisco.com/AXL/API/11.0}OXDirn" minOccurs="0"/>
 *         &lt;element name="ringSetting" type="{http://www.cisco.com/AXL/API/11.0}OXFkType" minOccurs="0"/>
 *         &lt;element name="consecutiveRingSetting" type="{http://www.cisco.com/AXL/API/11.0}OXFkType" minOccurs="0"/>
 *         &lt;element name="ringSettingIdlePickupAlert" type="{http://www.cisco.com/AXL/API/11.0}OXFkType" minOccurs="0"/>
 *         &lt;element name="ringSettingActivePickupAlert" type="{http://www.cisco.com/AXL/API/11.0}OXFkType" minOccurs="0"/>
 *         &lt;element name="mwlPolicy" type="{http://www.cisco.com/AXL/API/11.0}OXFkType" minOccurs="0"/>
 *         &lt;element name="recordingProfileName" type="{http://www.cisco.com/AXL/API/11.0}OXFkType" minOccurs="0"/>
 *         &lt;element name="monitoringCssName" type="{http://www.cisco.com/AXL/API/11.0}OXFkType" minOccurs="0"/>
 *         &lt;element name="recordingFlag" type="{http://www.cisco.com/AXL/API/11.0}OXFkType" minOccurs="0"/>
 *         &lt;element name="audibleMwi" type="{http://www.cisco.com/AXL/API/11.0}OXFkType" minOccurs="0"/>
 *         &lt;element name="partitionUsage" type="{http://www.cisco.com/AXL/API/11.0}OXFkType" minOccurs="0"/>
 *         &lt;element name="recordingMediaSource" type="{http://www.cisco.com/AXL/API/11.0}OXFkType" minOccurs="0"/>
 *       &lt;/sequence>
