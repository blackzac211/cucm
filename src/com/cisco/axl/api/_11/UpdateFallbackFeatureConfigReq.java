 ...
 *       &lt;sequence>
 *         &lt;element name="enableFallbackForImeCalls" type="{http://www.cisco.com/AXL/API/11.0}boolean" minOccurs="0"/>
 *         &lt;element name="qosSensistivityLevel" type="{http://www.cisco.com/AXL/API/11.0}XInteger" minOccurs="0"/>
 *         &lt;element name="dtmfCorrelationDigits" type="{http://www.cisco.com/AXL/API/11.0}XInteger" minOccurs="0"/>
 *         &lt;element name="dtmfCollectionTimer" type="{http://www.cisco.com/AXL/API/11.0}XInteger" minOccurs="0"/>
 *         &lt;element name="callAnswerTimer" type="{http://www.cisco.com/AXL/API/11.0}XInteger" minOccurs="0"/>
 *         &lt;element name="clearImeCallDelayTimer" type="{http://www.cisco.com/AXL/API/11.0}XInteger" minOccurs="0"/>
 *         &lt;element name="dtmfInterDigitDelayTimer" type="{http://www.cisco.com/AXL/API/11.0}XInteger" minOccurs="0"/>
 *         &lt;element name="postConnectFallbackDelayTimer" type="{http://www.cisco.com/AXL/API/11.0}XInteger" minOccurs="0"/>
 *         &lt;element name="fallbackSplitDelayTimer" type="{http://www.cisco.com/AXL/API/11.0}XInteger" minOccurs="0"/>
 *         &lt;element name="callCss" type="{http://www.cisco.com/AXL/API/11.0}XInteger" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class UpdateFallbackFeatureConfigReq {
    ...
    @XmlElementRef(name = "enableFallbackForImeCalls", type = JAXBElement.class, required = false)
    protected JAXBElement<String> enableFallbackForImeCalls;
    @XmlElementRef(name = "qosSensistivityLevel", type = JAXBElement.class, required = false)
    protected JAXBElement<String> qosSensistivityLevel;
    @XmlElementRef(name = "dtmfCorrelationDigits", type = JAXBElement.class, required = false)
    protected JAXBElement<String> dtmfCorrelationDigits;
    @XmlElementRef(name = "dtmfCollectionTimer", type = JAXBElement.class, required = false)
    protected JAXBElement<String> dtmfCollectionTimer;
    @XmlElementRef(name = "callAnswerTimer", type = JAXBElement.class, required = false)
    protected JAXBElement<String> callAnswerTimer;
    @XmlElementRef(name = "clearImeCallDelayTimer", type = JAXBElement.class, required = false)
    protected JAXBElement<String> clearImeCallDelayTimer;
    @XmlElementRef(name = "dtmfInterDigitDelayTimer", type = JAXBElement.class, required = false)
    protected JAXBElement<String> dtmfInterDigitDelayTimer;
    @XmlElementRef(name = "postConnectFallbackDelayTimer", type = JAXBElement.class, required = false)
    protected JAXBElement<String> postConnectFallbackDelayTimer;
    @XmlElementRef(name = "fallbackSplitDelayTimer", type = JAXBElement.class, required = false)
    protected JAXBElement<String> fallbackSplitDelayTimer;
    @XmlElementRef(name = "callCss", type = JAXBElement.class, required = false)
