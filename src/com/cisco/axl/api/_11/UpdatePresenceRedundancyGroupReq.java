 ...
 *         &lt;element name="server1" type="{http://www.cisco.com/AXL/API/11.0}XFkType" minOccurs="0"/>
 *         &lt;element name="server2" type="{http://www.cisco.com/AXL/API/11.0}XFkType" minOccurs="0"/>
 *         &lt;element name="haEnabled" type="{http://www.cisco.com/AXL/API/11.0}boolean" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends NameAndGUIDRequest
{
    ...
    @XmlElementRef(name = "server1", type = JAXBElement.class, required = false)
    protected JAXBElement<XFkType> server1;
    @XmlElementRef(name = "server2", type = JAXBElement.class, required = false)
