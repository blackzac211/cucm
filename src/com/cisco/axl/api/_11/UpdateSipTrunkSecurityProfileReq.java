 ...
 *       &lt;sequence>
 *         &lt;element name="newName" type="{http://www.cisco.com/AXL/API/11.0}String64" minOccurs="0"/>
 *         &lt;element name="description" type="{http://www.cisco.com/AXL/API/11.0}String100" minOccurs="0"/>
 *         &lt;element name="securityMode" type="{http://www.cisco.com/AXL/API/11.0}XDeviceSecurityMode" minOccurs="0"/>
 *         &lt;element name="incomingTransport" type="{http://www.cisco.com/AXL/API/11.0}XTransport" minOccurs="0"/>
 *         &lt;element name="outgoingTransport" type="{http://www.cisco.com/AXL/API/11.0}XTransport" minOccurs="0"/>
 *         &lt;element name="digestAuthentication" type="{http://www.cisco.com/AXL/API/11.0}boolean" minOccurs="0"/>
 *         &lt;element name="noncePolicyTime" type="{http://www.cisco.com/AXL/API/11.0}XInteger" minOccurs="0"/>
 *         &lt;element name="x509SubjectName" type="{http://www.cisco.com/AXL/API/11.0}String4096" minOccurs="0"/>
 *         &lt;element name="incomingPort" type="{http://www.cisco.com/AXL/API/11.0}XInteger" minOccurs="0"/>
 *         &lt;element name="applLevelAuthentication" type="{http://www.cisco.com/AXL/API/11.0}boolean" minOccurs="0"/>
 ...
 *         &lt;element name="transmitSecurityStatus" type="{http://www.cisco.com/AXL/API/11.0}boolean" minOccurs="0"/>
 *         &lt;element name="sipV150OutboundSdpOfferFiltering" type="{http://www.cisco.com/AXL/API/11.0}XV150SDPFilter" minOccurs="0"/>
 *         &lt;element name="allowChargingHeader" type="{http://www.cisco.com/AXL/API/11.0}boolean" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends NameAndGUIDRequest
{
    ...
    @XmlElementRef(name = "securityMode", type = JAXBElement.class, required = false)
    protected JAXBElement<String> securityMode;
    @XmlElement(defaultValue = "TCP+UDP")
    protected String incomingTransport;
    @XmlElementRef(name = "outgoingTransport", type = JAXBElement.class, required = false)
