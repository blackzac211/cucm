 ...
 *             &lt;element name="routePartitionName" type="{http://www.cisco.com/AXL/API/11.0}XFkType"/>
 *             &lt;element name="dialPlanName" type="{http://www.cisco.com/AXL/API/11.0}XFkType"/>
 *             &lt;element name="routeFilterName" type="{http://www.cisco.com/AXL/API/11.0}XFkType"/>
 *           &lt;/sequence>
 *         &lt;/choice>
 ...
 *         &lt;element name="blockEnable" type="{http://www.cisco.com/AXL/API/11.0}boolean" minOccurs="0"/>
 ...
 *         &lt;element name="useCallingPartyPhoneMask" type="{http://www.cisco.com/AXL/API/11.0}XStatus" minOccurs="0"/>
 *         &lt;element name="callingPartyPrefixDigits" type="{http://www.cisco.com/AXL/API/11.0}String50" minOccurs="0"/>
 *         &lt;element name="newDialPlanName" type="{http://www.cisco.com/AXL/API/11.0}XFkType" minOccurs="0"/>
 *         &lt;element name="digitDiscardInstructionName" type="{http://www.cisco.com/AXL/API/11.0}XFkType" minOccurs="0"/>
 ...
 *         &lt;element name="newRouteFilterName" type="{http://www.cisco.com/AXL/API/11.0}XFkType" minOccurs="0"/>
 *         &lt;element name="callingLinePresentationBit" type="{http://www.cisco.com/AXL/API/11.0}XPresentationBit" minOccurs="0"/>
 *         &lt;element name="callingNamePresentationBit" type="{http://www.cisco.com/AXL/API/11.0}XPresentationBit" minOccurs="0"/>
 *         &lt;element name="connectedLinePresentationBit" type="{http://www.cisco.com/AXL/API/11.0}XPresentationBit" minOccurs="0"/>
 *         &lt;element name="connectedNamePresentationBit" type="{http://www.cisco.com/AXL/API/11.0}XPresentationBit" minOccurs="0"/>
 *         &lt;element name="supportOverlapSending" type="{http://www.cisco.com/AXL/API/11.0}boolean" minOccurs="0"/>
 ...
 *         &lt;element name="allowDeviceOverride" type="{http://www.cisco.com/AXL/API/11.0}boolean" minOccurs="0"/>
 *         &lt;element name="provideOutsideDialtone" type="{http://www.cisco.com/AXL/API/11.0}boolean" minOccurs="0"/>
 *         &lt;element name="callingPartyNumberingPlan" type="{http://www.cisco.com/AXL/API/11.0}XNumberingPlan" minOccurs="0"/>
 *         &lt;element name="callingPartyNumberType" type="{http://www.cisco.com/AXL/API/11.0}XPriOfNumber" minOccurs="0"/>
 *         &lt;element name="calledPartyNumberingPlan" type="{http://www.cisco.com/AXL/API/11.0}XNumberingPlan" minOccurs="0"/>
 *         &lt;element name="calledPartyNumberType" type="{http://www.cisco.com/AXL/API/11.0}XPriOfNumber" minOccurs="0"/>
 *         &lt;element name="destination" minOccurs="0">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;choice>
 *                   &lt;element name="gatewayName" type="{http://www.cisco.com/AXL/API/11.0}XFkType"/>
 *                   &lt;element name="routeListName" type="{http://www.cisco.com/AXL/API/11.0}XFkType"/>
 *                 &lt;/choice>
 *               &lt;/restriction>
 *             &lt;/complexContent>
 *           &lt;/complexType>
 *         &lt;/element>
 *         &lt;element name="authorizationCodeRequired" type="{http://www.cisco.com/AXL/API/11.0}boolean" minOccurs="0"/>
 *         &lt;element name="authorizationLevelRequired" type="{http://www.cisco.com/AXL/API/11.0}XInteger" minOccurs="0"/>
 *         &lt;element name="clientCodeRequired" type="{http://www.cisco.com/AXL/API/11.0}boolean" minOccurs="0"/>
 ...
 *                   &lt;element name="networkServiceProtocol" type="{http://www.cisco.com/AXL/API/11.0}XPriProtocol"/>
 *                   &lt;element name="networkService" type="{http://www.cisco.com/AXL/API/11.0}XNSFService" minOccurs="0"/>
 ...
 *           &lt;/complexType>
 *         &lt;/element>
 *         &lt;element name="resourcePriorityNamespaceName" type="{http://www.cisco.com/AXL/API/11.0}XFkType" minOccurs="0"/>
 *         &lt;element name="routeClass" type="{http://www.cisco.com/AXL/API/11.0}XPatternRouteClass" minOccurs="0"/>
 *         &lt;element name="enableDccEnforcement" type="{http://www.cisco.com/AXL/API/11.0}boolean" minOccurs="0"/>
 *         &lt;element name="blockedCallPercentage" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *         &lt;element name="externalCallControl" type="{http://www.cisco.com/AXL/API/11.0}XFkType" minOccurs="0"/>
 *         &lt;element name="isEmergencyServiceNumber" type="{http://www.cisco.com/AXL/API/11.0}boolean" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends APIRequest
{
    ...
    @XmlElementRef(name = "dialPlanName", type = JAXBElement.class, required = false)
    protected JAXBElement<XFkType> dialPlanName;
    @XmlElementRef(name = "routeFilterName", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "calledPartyTransformationMask", type = JAXBElement.class, required = false)
    protected JAXBElement<String> calledPartyTransformationMask;
    @XmlElementRef(name = "callingPartyTransformationMask", type = JAXBElement.class, required = false)
    protected JAXBElement<String> callingPartyTransformationMask;
    @XmlElement(defaultValue = "Default")
    protected String useCallingPartyPhoneMask;
    @XmlElementRef(name = "callingPartyPrefixDigits", type = JAXBElement.class, required = false)
    protected JAXBElement<String> callingPartyPrefixDigits;
    @XmlElementRef(name = "newDialPlanName", type = JAXBElement.class, required = false)
    protected JAXBElement<XFkType> newDialPlanName;
    @XmlElementRef(name = "digitDiscardInstructionName", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "prefixDigitsOut", type = JAXBElement.class, required = false)
    protected JAXBElement<String> prefixDigitsOut;
    @XmlElementRef(name = "newRouteFilterName", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "resourcePriorityNamespaceName", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "blockedCallPercentage", type = JAXBElement.class, required = false)
    protected JAXBElement<String> blockedCallPercentage;
    @XmlElementRef(name = "externalCallControl", type = JAXBElement.class, required = false)
