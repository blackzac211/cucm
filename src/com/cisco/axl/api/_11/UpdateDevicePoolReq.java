 ...
 *       &lt;sequence>
 *         &lt;element name="newName" type="{http://www.cisco.com/AXL/API/11.0}UniqueString50" minOccurs="0"/>
 *         &lt;element name="autoSearchSpaceName" type="{http://www.cisco.com/AXL/API/11.0}XFkType" minOccurs="0"/>
 *         &lt;element name="dateTimeSettingName" type="{http://www.cisco.com/AXL/API/11.0}XFkType" minOccurs="0"/>
 *         &lt;element name="callManagerGroupName" type="{http://www.cisco.com/AXL/API/11.0}XFkType" minOccurs="0"/>
 *         &lt;element name="mediaResourceListName" type="{http://www.cisco.com/AXL/API/11.0}XFkType" minOccurs="0"/>
 *         &lt;element name="regionName" type="{http://www.cisco.com/AXL/API/11.0}XFkType" minOccurs="0"/>
 *         &lt;element name="networkLocale" type="{http://www.cisco.com/AXL/API/11.0}XCountry" minOccurs="0"/>
 *         &lt;element name="srstName" type="{http://www.cisco.com/AXL/API/11.0}XFkType" minOccurs="0"/>
 *         &lt;element name="connectionMonitorDuration" type="{http://www.cisco.com/AXL/API/11.0}XInteger" minOccurs="0"/>
 ...
 *         &lt;element name="mobilityCssName" type="{http://www.cisco.com/AXL/API/11.0}XFkType" minOccurs="0"/>
 *         &lt;element name="physicalLocationName" type="{http://www.cisco.com/AXL/API/11.0}XFkType" minOccurs="0"/>
 *         &lt;element name="deviceMobilityGroupName" type="{http://www.cisco.com/AXL/API/11.0}XFkType" minOccurs="0"/>
 *         &lt;element name="revertPriority" type="{http://www.cisco.com/AXL/API/11.0}XRevertPriority" minOccurs="0"/>
 ...
 *         &lt;element name="localRouteGroupName" type="{http://www.cisco.com/AXL/API/11.0}XFkType" minOccurs="0"/>
 ...
 *         &lt;element name="adjunctCallingSearchSpace" type="{http://www.cisco.com/AXL/API/11.0}XFkType" minOccurs="0"/>
 ...
 *         &lt;element name="imeEnrolledPatternGroupName" type="{http://www.cisco.com/AXL/API/11.0}XFkType" minOccurs="0"/>
 ...
 *         &lt;element name="callingPartyTransformationCSS" type="{http://www.cisco.com/AXL/API/11.0}XFkType" minOccurs="0"/>
    ...
    extends NameAndGUIDRequest
{
    ...
    @XmlElementRef(name = "autoSearchSpaceName", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "mobilityCssName", type = JAXBElement.class, required = false)
    protected JAXBElement<XFkType> mobilityCssName;
    @XmlElementRef(name = "physicalLocationName", type = JAXBElement.class, required = false)
    protected JAXBElement<XFkType> physicalLocationName;
    @XmlElementRef(name = "deviceMobilityGroupName", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "adjunctCallingSearchSpace", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "imeEnrolledPatternGroupName", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "callingPartyTransformationCSS", type = JAXBElement.class, required = false)
