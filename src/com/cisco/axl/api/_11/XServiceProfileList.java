 ...
 *         &lt;element name="serverCertificateVerification" type="{http://www.cisco.com/AXL/API/11.0}XCertificateVerificationLevel" minOccurs="0"/>
 *         &lt;element name="serviceProfileXml" type="{http://www.cisco.com/AXL/API/11.0}XVendorConfig" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class XServiceProfileList {
    ...
    @XmlElementRef(name = "tertiary", type = JAXBElement.class, required = false)
    protected JAXBElement<String> tertiary;
    @XmlElementRef(name = "serverCertificateVerification", type = JAXBElement.class, required = false)
