 ...
 *         &lt;element name="revertCssName" type="{http://www.cisco.com/AXL/API/11.0}XFkType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends APIRequest
{
    ...
    @XmlElementRef(name = "retrievalPrefix", type = JAXBElement.class, required = false)
    protected JAXBElement<String> retrievalPrefix;
    @XmlElementRef(name = "reversionPattern", type = JAXBElement.class, required = false)
    protected JAXBElement<String> reversionPattern;
    @XmlElementRef(name = "revertCssName", type = JAXBElement.class, required = false)
